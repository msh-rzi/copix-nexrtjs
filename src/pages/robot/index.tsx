...
const robotsDefault = [
  {
    ...
    description: 'This is a test robot 1'
  },
  { id: '2', name: 'Trade Pulse', path: '/robot/trade-pulse', description: 'This is a test robot 2' }
]

const Robots = () => {
  const [robots] = useState<RobotsType[]>(robotsDefault)
  const [userRobots, setUserRobots] = useState<UserRobotsType[]>([])
  ...
  const getRobots = async () => {
    ...
    if (robotsReq.isOk && robotsReq.data.retCode === 0 && robots.length === 0) {
      // TODO: Filter out inactive robots
